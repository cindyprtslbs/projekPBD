                    ...
                    <div class="card-body">
                        ...
                        <form method="post" >
                            ...
                            <div class="form-group">
                                ...
                                <select name="idpenjualan" class="form-control" id="idpenjualan" required>
                                    <?php
                                    $result = $db->query("SELECT * FROM penjualan");
                        ...
                        if (isset($_POST['tambah'])) {
                            ...
                            $query = $db->query("INSERT INTO detail_penjualan (jumlah, idpenjualan, idbarang)
                            ...
                            if ($query) {
                                ...
                                echo "<script>alert('Gagal menambahkan detail penjualan!'); window.location = 'add_penjualan.php';</script>";
                            }
                        }
                        ?>
                    </div>
