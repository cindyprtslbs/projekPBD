        ...
        <div class="row">
          ...
          <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Form Tambah Detail Penjualan</h3>
                    </div>
                    <div class="card-body">
                      <?php include 'konek.php'; ?>
                        <form method="post">
                          ...
                          <button type="submit" name="tambah" class="btn btn-primary">Tambah Detail Penjualan</button>
                        </form>

                        <?php
                        include 'konek.php';

                        // Ambil idpenjualan dari URL
                        $idpenjualan = isset($_GET['idpenjualan']) ? $_GET['idpenjualan'] : null;
                        ...
                        if (isset($_POST['tambah'])) {
                            ...
                            for ($i = 0; $i < count($idbarangs); $i++) {
                                ...
                                $queryInsertDetail = $db->query("INSERT INTO detail_penjualan (jumlah, idpenjualan, idbarang)
                                                                    VALUES ('$jumlah', '$idpenjualan', '$idbarang')");

                                if (!$queryInsertDetail) {
                                    echo "<script>alert('Gagal menambahkan detail penjualan!');</script>";
                                    break;
                                }
                            }

                            echo "<script>alert('Detail penjualan berhasil ditambahkan!');window.location=('penjualan.php')</script>";
                        }
                        ?>
                    </div>
                </div>
...
<script>
  document.getElementById('add-barang').addEventListener('click', function() {
    // Ambil container tempat barang-barang ditambahkan
    var container = document.getElementById('barang-container');

    // Buat elemen baru untuk form barang dan jumlah
