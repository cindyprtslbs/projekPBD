              ...
              <div class="card-body">
                ...
                <form method="post">
                    <div class="form-group">
                      ...
                      <input name="idbarang" type="text" class="form-control" id="idbarang">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="id_satuan" class="form-control" id="id_satuan">
                        <?php
                        $result = $db->query("SELECT * FROM satuan");
                        while ($row = $result->fetch_assoc()) {
                          echo "<option value='" . $row['idsatuan'] . "'>" . $row['idsatuan'] . " - " . $row['nama_satuan'] . "</option>";
                        }
                        ?>
                      </select>
                    </div>
                ...
                <?php
                    if (isset($_POST['simpan'])) {
                        ...
                        $q = $db->query("CALL tambahBarang('$idbarang', '$jenis', '$nama', '$id_satuan', '$status', '$harga')");

                        if ($q) {
                          echo "<script>window.alert('Berhasil');window.location=('Barang.php')</script>";
                        }else{
                          echo "<script>window.alert('Gagal Menambahkan Data');window.location=('add_barang.php')</script>";
                        }
                    }
                ?>
              </div>
