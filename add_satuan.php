              ...
              <div class="card-body">
                ...
                <form method="post">
                    <div class="form-group">
                      ...
                      <input name="idsatuan" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                ...
                <?php
                    if (isset($_POST['simpan'])) {
                        ...
                        $q = $db->query("CALL tambahSatuan('$idsatuan', '$nama_satuan', '$status')");

                        if ($q) {
                          echo "<script>window.alert('Berhasil');window.location=('satuan.php')</script>";
                        }else{
                          echo "<script>window.alert('Gagal Menambahkan Data');window.location=('add_satuan.php')</script>";
                        }
                    }
                ?>
              </div>
