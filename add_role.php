              ...
              <div class="card-body">
                ...
                <form method="post">
                    <div class="form-group">
                      <label>ID Role</label>
                      <input name="idrole" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                ...
                <?php
                    if (isset($_POST['simpan'])) {
                        ...
                        $q=$db->query("INSERT INTO role SET idrole='$idrole', nama_role='$nama_role'");
                        var_dump($q);

                        if ($q) {
                          echo "<script>window.alert('Berhasil');window.location=('user.php')</script>";
                        }else{
                          echo "<script>window.alert('Gagal Menambahkan Data');window.location=('add_role.php')</script>";
                        }
                    }
                ?>
              </div>
