...
if (isset($_GET['idpengadaan'])) {
  ...
  $queryCheck = "SELECT status FROM pengadaan WHERE idpengadaan = $idpengadaan";
  $result = $db->query($queryCheck);
  $row = $result->fetch_assoc();

  if ($row['status'] === 'complete') {
      echo "<script>alert('Pengadaan dengan ID $idpengadaan sudah diterima sebelumnya.');</script>";
  } else {
      $query = "UPDATE pengadaan SET status = 'complete' WHERE idpengadaan = $idpengadaan";
      $db->query($query);
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="penerimaan.php" class="nav-link active">
              <i class="nav-icon fas fa-boxes"></i>
              <p>
                Penerimaan
              </p>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    include 'konek.php';
                    $query = $db->query("SELECT * FROM penerimaan");
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="retur.php?idpenerimaan=<?php echo $tampil['idpenerimaan']; ?>" class="btn btn-info btn-xs">Tambah Retur</a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    include 'konek.php';
                    $query = $db->query("SELECT * FROM detail_penerimaan");
                    foreach ($query as $tampil) {
                    ?>
                  <tr>
                    ...
                    <td><?php echo $tampil["jumlah_terima"];?></td>
                    <td><?php echo $tampil["harga_satuan_terima"];?></td>
                    <td><?php echo $tampil["sub_total_terima"];?></td>
                  </tr>
                  <?php } ?>
                  </tbody>
                </table>
