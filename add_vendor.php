              ...
              <div class="card-body">
                ...
                <form method="post">
                    <div class="form-group">
                      ...
                      <input name="idvendor" type="text" class="form-control" >
                    </div>
                    <div class="form-group">
                      <label >Nama Vendor</label>
                      <input name="nama_vendor" type="text" class="form-control" >
                    </div>
                    <div class="form-group">
                      <label >Badan Hukum</label>
                      <input name="badan_hukum" type="text" class="form-control" >
                    </div>
                    <div class="form-group">
                ...
                <?php
                    if (isset($_POST['simpan'])) {
                        ...
                        $q = $db->query("CALL tambahVendor('$idvendor', '$nama_vendor', '$badan_hukum', '$status')");

                        if ($q) {
                          echo "<script>window.alert('Berhasil');window.location=('vendor.php')</script>";
                        }else{
                          echo "<script>window.alert('Gagal Menambahkan Data');window.location=('add_vendor.php')</script>";
                        }
                    }
                ?>
              </div>
