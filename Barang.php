            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  <a href="add_barang.php" class="btn btn-info">Create</a> <br><br>
                  <thead>
                    <tr>
                      <th>ID Barang</th>
                      <th>Jenis</th>
                  ...
                  <tbody>
                    <?php
                    include 'konek.php';
                    $query = $db->query("SELECT * FROM barang_detail");
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit_barang.php?id=<?php echo $tampil['idbarang']?>" class="btn btn-warning btn-xs" >Edit</a>
                      <a onclick="return confirm('Apakah Anda Yakin ingin Menghapus ini?')" href="hapus_barang.php?id=<?php echo $tampil['idbarang']?>" class="btn btn-danger btn-xs" >Delete</a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
