              ...
              <div class="card-body">
                ...
                <form method="post">
                    <div class="form-group">
                      <label>ID User</label>
                      <input name="iduser" type="text" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="idrole" class="form-control" id="idrole">
                        ...
                        while ($row = $result->fetch_assoc()) {
                          echo "<option value='" . $row['idrole'] . "'>" . $row['idrole'] . " - " . $row['nama_role'] . "</option>";
                        }
                        ?>
                      </select>
                    </div>
                    <td><button type="submit" name="simpan" class="btn btn-primary btn-xs">Simpan</button></td>
                </form>
                <?php
                    if (isset($_POST['simpan'])) {
                        ...
                        $query = $db->prepare("INSERT INTO user (iduser, username, password, idrole) VALUES (?, ?, ?, ?)");
                        $result = $query->execute([$iduser, $username, $password_hash, $idrole]);

                        if ($result) {
                          echo "<script>window.alert('Berhasil');window.location=('user.php')</script>";
                        }else{
                          echo "<script>window.alert('Gagal Menambahkan Data');window.location=('add_user.php')</script>";
                        }
                    }
                ?>
              </div>
