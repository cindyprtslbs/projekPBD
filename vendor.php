            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  <a href="add_vendor.php" class="btn btn-info">Create</a> <br><br>
                  <thead>
                    <tr>
                      <th>ID Vendor</th>
                      <th>Nama Vendor</th>
                  ...
                  <tbody>
                    <?php
                    include 'konek.php';
                    $query = $db->query("SELECT * FROM view_vendor");
                    foreach ($query as $tampil) {
                    ?>
                  <tr>
                    <td><?php echo $tampil["idvendor"];?></td>
                    <td><?php echo $tampil["nama_vendor"];?></td>
                    <td><?php echo $tampil["badan_hukum"];?></td>
                    <td><?php echo $tampil["status"];?></td>
                    <td>
                      <a href="edit_vendor.php?id=<?php echo $tampil['idvendor']?>" class="btn btn-warning btn-xs" >Edit</a>
                      <a onclick="return confirm('Apakah Anda Yakin ingin Menghapus ini?')" href="hapus_vendor.php?id=<?php echo $tampil['idvendor']?>" class="btn btn-danger btn-xs" >Delete</a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
