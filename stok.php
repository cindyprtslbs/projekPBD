...
<div class="wrapper">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Laporan Kartu Stok</h3>
              </div>
              <div class="card-body">
  ...
  <!-- <?php include 'konek.php';
    $idkartu_stok = $_GET['id'];
    $q = $db->query("DELETE FROM kartu_stok WHERE idkartu_stok='$idkartu_stok' ");
